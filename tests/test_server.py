...
def test_cookies_endpoint_single(client, test_url, expected_text, cf_cookie_prefixes):
...
def test_html_endpoint_single(client, test_url, expected_text, min_html_length):
